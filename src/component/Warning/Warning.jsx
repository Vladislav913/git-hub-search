...
const Warning = ({text}) => {
    return (
        <div className="warning">
            <svg className="warning__img" fill="none" height="300" viewBox="0 0 27 27" width="300" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke="#4F4F4F" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2"/>
                <path
